...
def leptop(request):
    return render(request,'ecom/leptop.html')

def phone(request):
    return render(request,'ecom/phone.html')

def camera(request):
    return render(request,'ecom/camera.html')

def smartwatch(request):
    return render(request,'ecom/smartwatch.html')

def telivision(request):
    return render(request,'ecom/telivision.html')

def webcams(request):
    return render(request,'ecom/webcams.html')

def printer(request):
    return render(request,'ecom/printer.html')

def drone(request):
    return render(request,'ecom/drone.html')

def cpu(request):
    return render(request,'ecom/cpu.html')

def moniter(request):
    return render(request,'ecom/moniter.html')

def speakers(request):
    return render(request,'ecom/speakers.html')
